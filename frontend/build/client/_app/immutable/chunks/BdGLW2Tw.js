...
import { b as Z } from "./26I3BnCA.js";
...
function ir(r, e) {
  ...
  const s = e.target,
    ...
    o = v;
  try {
    for (var t = P(s); t && (t.nodeType !== 8 || t.data !== Y); ) t = q(t);
    if (!t) throw T;
    g(!0), D(t), B();
    const u = k(r, { ...e, anchor: t });
    if (v === null || v.nodeType !== 8 || v.data !== $) throw (j(), T);
    return g(!1), u;
  } catch (u) {
    if (u === T) return e.recover === !1 && z(), b(), F(s), g(!1), tr(r, e);
    throw u;
  } finally {
    g(c), D(o);
  }
...
function k(
  r,
  { target: e, anchor: s, props: c = {}, events: o, context: t, intro: u = !0 },
) {
  b();
  var _ = new Set(),
    d = (i) => {
      ...
      return (
        ...
        () => {
          ...
          for (var a of _) {
            ...
            var n = p.get(a);
            --n === 0
              ? (document.removeEventListener(a, m), p.delete(a))
              : p.set(a, n);
          }
          O.delete(d),
